...
if (isset($_POST['fechadesde']) && $_POST['fechadesde']!=''&& isset($_POST['fechahasta']) && $_POST['fechahasta']!='') {
  ...
  $result = mysqli_query($connString, "SELECT fechacompra,razonsocialproveedor,cuilproveedor,tiponombre, numerofactura,nombreempleado,
...
$pdf->Cell(31,8,"Fecha de compra",1,0,'C');
$pdf->Cell(31,8,"Proveedor",1,0,'C');
$pdf->Cell(31,8,"Cuil Proveedor",1,0,'C');
