...
<body class=" theme-blue">
  ...
  <div class="content">
    <div class="header">
      <h1 class="page-title">Proveedores - Agregar Direccion</h1>
      <!-- Navegador -->
      <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="panel panel-default">
              <div class="panel-heading no-collapse">Direcci&oacute;n</div> 
                <?php include "inc_proveedores/inc_proveedor_direccion_agregar.php" ?>                     
        </div>
        </div>
