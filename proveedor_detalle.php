	...
	<div class="content">
		<div class="header">
			...
			<ul class="breadcrumb">
	    		...
	    		<li class="active">Detalle Proveedor</li>
			</ul>
		</div>
		...
		<div class="row">
    		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            	...
            	<div class="panel-heading no-collapse">Datos Proveedor</div>
            		<?php include "inc_proveedores/inc_proveedor_detalle_datos.php" ?>                     
				</div>
    		</div>
    		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        		<div class="panel panel-default">
            	<div class="panel-heading no-collapse">Direcciones</div> 
            		<?php include "inc_proveedores/inc_proveedor_detalle_direcciones.php" ?>                     
				</div>
    		</div>
		</div>
